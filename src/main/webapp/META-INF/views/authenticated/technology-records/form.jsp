...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.technology-records.form.label.inventor" path="inventor"/>
	...
	<acme:form-textbox code="authenticated.technology-records.form.label.openSource" path="openSource"/>
	<acme:form-textbox code="authenticated.technology-records.form.label.stars" path="stars"/>
