...
<acme:form readonly = "true">
	<acme:form-textbox code="authenticated.notice.form.label.headerImage" path="headerImage"/>
	<acme:form-textbox code="authenticated.notice.form.label.title" path="title"/>
	<acme:form-textbox code="authenticated.notice.form.label.moment" path="moment"/>
