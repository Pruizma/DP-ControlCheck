...
@Service
public class EntrepreneusApplicationListTickerService implements AbstractListService<Entrepreneus, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findApplicationGroupedByTicker(principal.getActiveRoleId());
		return result;
	}
}
