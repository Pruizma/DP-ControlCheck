...
@Service
public class EntrepreneusApplicationListFechaService implements AbstractListService<Entrepreneus, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findApplicationGroupedByMoment(principal.getActiveRoleId());
		return result;
	}
}
