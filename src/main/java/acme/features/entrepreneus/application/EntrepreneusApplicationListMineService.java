...
@Service
public class EntrepreneusApplicationListMineService implements AbstractListService<Entrepreneus, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findManyByEntrepreneusId(principal.getActiveRoleId());
		return result;
	}
}
