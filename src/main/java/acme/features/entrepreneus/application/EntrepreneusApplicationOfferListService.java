...
@Service
public class EntrepreneusApplicationOfferListService implements AbstractListService<Entrepreneus, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findApplicationsByExistsOffer(principal.getActiveRoleId());
		return result;
	}
}
