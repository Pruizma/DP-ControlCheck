...
@Service
public class BookkeeperInvestmentListNotMineService implements AbstractListService<Bookkeeper, Investment> {
	...
	public Collection<Investment> findMany(final Request<Investment> request) {
		...
		result = this.repository.findByNotBookkeeperId(principal.getActiveRoleId());
